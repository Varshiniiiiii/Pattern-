...
class Umpire
{
	...
	void compare()
	{
		...
		if(numFromGuesser==numFromPlayer1)
		{
			...
			{
				System.out.println("Game tied all three players guessed correctly So Play One More time");
				Player p1=new Player();
				Player p2=new Player();
				Player p3=new Player();
				...
				if(numFromGuesser==numFromPlayer1)
				{
					if(numFromGuesser==numFromPlayer2 && numFromGuesser==numFromPlayer3)
					{
						System.out.println("It's a tie Again So declaring all the 3 players has won the game");
